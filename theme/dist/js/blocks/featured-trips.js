...
/******/ 	return __webpack_require__(__webpack_require__.s = "./theme/src/js/blocks/featured-trips.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./theme/src/js/blocks/featured-trips.js":
/*!***********************************************!*\
  !*** ./theme/src/js/blocks/featured-trips.js ***!
  \***********************************************/
/*! no exports provided */
...
registerBlockType('rbt/featured-trips', {
  ...
  edit: function edit(_ref) {
    ...
    var title = attributes.title,
      ...
      selectedTrips = attributes.selectedTrips,
      bgType = attributes.bgType,
      bgColor = attributes.bgColor,
      bgColorTwo = attributes.bgColorTwo,
      expandAdder = attributes.expandAdder,
      leftColWidth = attributes.leftColWidth,
      isLinearGradient = attributes.isLinearGradient,
      gradientArg = attributes.gradientArg,
      gap = attributes.gap,
      componentIdentifier = attributes.componentIdentifier;
    {
      componentIdentifier === 0 ? setAttributes({
        componentIdentifier: Math.floor(Math.random() * 90000) + 10000
      }) : null;
    }
    var breakpoint = 991; //set breakpoints here or import from JSON
    var mediakey = '@media (max-width: ' + breakpoint + 'px)';
    function inlineStyleWithMediaQuery() {
      return /*#__PURE__*/React.createElement("style", {
        dangerouslySetInnerHTML: {
          __html: "\n                    .rbt-featured-trips .layout._".concat(componentIdentifier, " .leftcol{\n                        width: Calc( ").concat(leftColWidth, "% - ").concat(Math.floor(gap / 2), "px);\n                    }\n                    .rbt-featured-trips .layout._").concat(componentIdentifier, " .rightcol{\n                        width: Calc( ").concat(100 - leftColWidth, "% - ").concat(Math.floor(gap / 2), "px );\n                    }\n                    @media (max-width: ").concat(breakpoint, "px){\n                        .rbt-featured-trips .layout._").concat(componentIdentifier, " .leftcol{width:100%;}\n                        .rbt-featured-trips .layout._").concat(componentIdentifier, " .rightcol{width:100%;}\n                    }\n                ")
        }
      });
    }
    ...
    function RemovePostButtonClick(post_id) {
      var updatedTrips = selectedTrips.filter(function (trip) {
        return trip.id !== post_id;
      });
      setAttributes({
    ...
    function AddPostButtonClick(pageobject) {
      ...
      if (typeof pageobject._embedded === "undefined") {
        setAttributes({
          selectedTrips: [].concat(_toConsumableArray(selectedTrips), [{
            id: pageobject.id,
            title: pageobject.title,
            excerpt: pageobject.excerpt,
    ...
    function SelectPage() {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SearchControl, {
        onChange: setSearchTerm,
        value: searchTerm
      }), /*#__PURE__*/React.createElement(PagesList, {
    ...
    function PagesList(_ref2) {
      var hasResolved = _ref2.hasResolved,
        pages = _ref2.pages;
      if (!hasResolved) {
        return /*#__PURE__*/React.createElement(Spinner, null);
      }
      if (!(pages !== null && pages !== void 0 && pages.length)) {
        return /*#__PURE__*/React.createElement("div", null, "No results");
      }
      var selectedIds = selectedTrips.map(function (trip) {
        return trip.id;
      });
      return /*#__PURE__*/React.createElement("table", {
        className: "wp-list-table widefat fixed striped table-view-list"
      }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "Trip Title"), /*#__PURE__*/React.createElement("th", null, "Feature"))), /*#__PURE__*/React.createElement("tbody", null, pages === null || pages === void 0 ? void 0 : pages.map(function (page) {
        if (!selectedIds.includes(page.id)) {
          return /*#__PURE__*/React.createElement("tr", {
            key: page.id
          }, /*#__PURE__*/React.createElement("td", null, decodeEntities(page.title.rendered)), /*#__PURE__*/React.createElement("td", null, selectedTrips.length < 4 && /*#__PURE__*/React.createElement(Button, {
            variant: "primary",
    ...
    function TripCard(selectedTrips) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          src: trip.featuredImage.medium.source_url
        })), /*#__PURE__*/React.createElement("div", {
          className: "trip-details"
        }, /*#__PURE__*/React.createElement("h3", {
          className: "trip-title"
        }, decodeEntities(trip.title.rendered)), /*#__PURE__*/React.createElement("div", {
          className: "trip-excerpt"
        }, stripTheTags(decodeEntities(trip.excerpt.rendered))), /*#__PURE__*/React.createElement("span", {
          className: "rbt-cta"
        }, "Details!"), /*#__PURE__*/React.createElement(Button, {
          variant: "secondary",
          className: "rbt-editor-remove",
          onClick: function onClick() {
            RemovePostButtonClick(trip.id);
          }
        }, "Remove Post")));
      }));
    }
    function RenderBackgroundDetails(_ref3) {
      var type = _ref3.type;
      switch (type) {
        case "Image":
        ...
        case "Color":
          ...
          break;
        case "Gradient":
          return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Gradient Start Color:")), /*#__PURE__*/React.createElement(ColorPicker, {
            color: bgColor,
            onChange: function onChange(color) {
              return setColorOne(color);
            },
            ...
            enableAlpha: true
          }), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Gradient Style")), /*#__PURE__*/React.createElement(ToggleControl, {
    ...
    return [/*#__PURE__*/React.createElement(InspectorControls, {
      ...
      title: "Layout"
    }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Switch Direction?")), /*#__PURE__*/React.createElement(ToggleControl, {
    ...
    }), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Column Width")), /*#__PURE__*/React.createElement(RangeControl, {
      label: "Left / Right",
      value: columns,
      ...
      title: "Background"
    }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Background Settings:")), console.log("bgType", bgType), /*#__PURE__*/React.createElement(SelectControl, {
      ...
      type: bgType
    }))), /*#__PURE__*/React.createElement(React.Fragment, null, inlineStyleWithMediaQuery(), /*#__PURE__*/React.createElement("div", {
      className: "rbt-featured-trips"
    }, /*#__PURE__*/React.createElement("div", {
      className: "underlay",
      style: renderStyle()
    }), /*#__PURE__*/React.createElement("div", {
      ...
      className: reversed ? "layout reversed _" + componentIdentifier : "layout _" + componentIdentifier
    }, /*#__PURE__*/React.createElement("div", {
      className: "leftcol"
    }, selectedTrips && selectedTrips.length ? TripCard(selectedTrips) : null, selectedTrips.length < 4 ? expandAdder ? SelectPage() : /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      onClick: function onClick() {
        setAttributes({
          expandAdder: !expandAdder
    ...
    }, "Add Trip to Section") : null), /*#__PURE__*/React.createElement("div", {
      className: "rightcol"
  ...
  save: function save(_ref5) {
    ...
    function TripCard(selectedTrips) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "trip-title"
        }, trip.title.rendered), /*#__PURE__*/React.createElement("div", {
          className: "trip-excerpt"
        }, stripTheTags(decodeEntities(trip.excerpt.rendered))), /*#__PURE__*/React.createElement("span", {
          className: "rbt-cta"
        }, "Details!")));
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: reversed ? "layout reversed" : "layout"
    }, /*#__PURE__*/React.createElement("div", {
      className: "leftcol"
      ...
      className: "rbt-featured-trips-text"
    }, /*#__PURE__*/React.createElement(RichText.Content, {
      tagName: "p",
      value: text
    })))));
...
/******/ });
//# sourceMappingURL=featured-trips.js.map