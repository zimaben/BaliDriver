...
/******/ 	return __webpack_require__(__webpack_require__.s = "./theme/src/js/blocks/card-section.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./theme/src/js/blocks/card-section.js":
/*!*********************************************!*\
  !*** ./theme/src/js/blocks/card-section.js ***!
  \*********************************************/
/*! no exports provided */
...
var ALLOWED = ['rbt/card-section-card'];
registerBlockType('rbt/card-section', {
  ...
  edit: function edit(_ref) {
    ...
    var title = attributes.title,
      ...
      scrollTriggerFunction = attributes.scrollTriggerFunction;
    ...
    return [/*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      ...
      options: [{
        ...
        label: "Scroll Reveal SVG",
        value: "scrollSVG"
      }],
      onChange: function onChange(val) {
        setAttributes({
          scrollTriggerFunction: val
        });
      }
    }))), /*#__PURE__*/React.createElement("div", {
      className: "rbt-card-section"
    }, svgMarkup.length && /*#__PURE__*/React.createElement("div", {
      className: "underlay",
...
/******/ });
//# sourceMappingURL=card-section.js.map