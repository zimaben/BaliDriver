  ...
  processlist.forEach(function (item) {
    ...
    switch (process) {
      ...
      case "doCurrencyPicker":
        ...
        break;
      case "scrollTrigger":
        var functionname = item.getAttribute('data-scroll-function');
        switch (functionname) {
          case "scrollSVG":
            //add scrolltrigger (intersection observer)
            console.log("adding observer");
            Object(_frontend_scroll_js__WEBPACK_IMPORTED_MODULE_4__["addObserver"])(item, {
              cb: _frontend_scroll_js__WEBPACK_IMPORTED_MODULE_4__["scrollSVG"],
              unbind: _frontend_scroll_js__WEBPACK_IMPORTED_MODULE_4__["removeScrollSVG"]
            });
            break;
          default:
            break;
...
/*!*****************************************!*\
  !*** ./theme/src/js/frontend/global.js ***!
  \*****************************************/
/*! exports provided: doDismiss, mobileExpand, removeSpinner, rbtSpinner, menuClick, doMenuClicks, doMobileMenuClick, accordionClick, doAccordionClicks, stickyNav, sendit, scrollThrottle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rbtSpinner", function() { return rbtSpinner; });
...
var removeSpinner = function removeSpinner(target) {
  var spinner = target.querySelector('.rbt-spinner');
  if (spinner) spinner.remove();
};
var rbtSpinner = function rbtSpinner(target) {
  var markup = "<div class=\"lds-spinner\">\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n      <div></div>\n    </div>";
  ...
  if (_typeof(target) === "object") target.appendChild(div);
};
...
/*!*****************************************!*\
  !*** ./theme/src/js/frontend/scroll.js ***!
  \*****************************************/
/*! exports provided: removeScrollSVG, scrollSVG, doScrollReveal, addObserver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeScrollSVG", function() { return removeScrollSVG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollSVG", function() { return scrollSVG; });
...
var removeScrollSVG = function removeScrollSVG(item) {
  document.removeEventListener('scroll', doScrollSVG);
};
var scrollSVG = function scrollSVG(item) {
  var svg = item.querySelector('svg');
  if (!svg) return false;
  window.currentScrollItem = item;
  document.addEventListener('scroll', doScrollSVG);
};
var doScrollSVG = function doScrollSVG() {
  var item = window.currentScrollItem;
  var parent = item.closest('.rbt-card-section');
  var cards = parent.querySelectorAll('.rbt-card-image > .imgwrap');
  var svg = item.querySelector('svg');
  var path = svg.querySelector('#svg-map-line');
  var elementTop = item.getBoundingClientRect().top;
  var pixels_scrolled_from_item_top = window.scrollY - elementTop;
  var scrollPercent = Math.min(pixels_scrolled_from_item_top / item.clientHeight, 1);
  var pathLength = path.getTotalLength();
  path.style.strokeDasharray = pathLength;
  path.style.strokeDashoffset = pathLength;
  var drawLength = Math.max(pathLength * scrollPercent, 0);
  ...
  switch (cards.length) {
    ...
    case 1:
      if (scrollPercent > .45) {
        ...
        cards[0].style.backgroundImage = "url(".concat(cards[0].getAttribute('data-image-light'), ")");
      } else {
        cards[0].classList.remove('active');
        cards[0].style.backgroundImage = "url(".concat(cards[0].getAttribute('data-image-dark'), ")");
      }
      ;
      break;
    case 2:
      ...
      if (scrollPercent > .6) {
        ...
        cards[1].style.backgroundImage = "url(".concat(cards[1].getAttribute('data-image-light'), ")");
      } else {
        cards[1].classList.remove('active');
        cards[1].style.backgroundImage = "url(".concat(cards[1].getAttribute('data-image-dark'), ")");
      }
      break;
    case 3:
      if (scrollPercent > .07) {
      ...
      if (scrollPercent > .82) {
        ...
        cards[2].style.backgroundImage = "url(".concat(cards[2].getAttribute('data-image-light'), ")");
      } else {
        cards[2].classList.remove('active');
        cards[2].style.backgroundImage = "url(".concat(cards[2].getAttribute('data-image-dark'), ")");
      }
      break;
  }
};
