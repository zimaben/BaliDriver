...
var loadImage = function loadImage(url) {
  return new Promise(function (resolve, reject) {
    if (!url) {
      reject("missing progressive header image");
    } else {
      var img = new Image();
...
var submitBookingForm = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var submit_button, form, url, nonce, inputs, response_target, senddata;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          url = theme_vars.ajaxurl + '?action=submit_booking_form';
          nonce = theme_vars.nonce;
          inputs = form.querySelectorAll('input, textarea, select');
          response_target = document.getElementById('booking-form-response');
          senddata = Array.from(inputs).map(function (input) {
          ...
          postit(url, senddata).then(function (r) {
            if (r.status === 200) {
              console.log(r);
  ...
  return function submitBookingForm(_x3) {
...
window.rbtSpinner = _frontend_global_js__WEBPACK_IMPORTED_MODULE_0__["rbtSpinner"];
window.endSpinner = _frontend_global_js__WEBPACK_IMPORTED_MODULE_0__["removeSpinner"];
