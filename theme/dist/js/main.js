...
var pageHeaderVideo = function pageHeaderVideo() {
  ...
  if (phv) {
    var hasSource = phv.getElementsByTagName('SOURCE');
...
var doProgressiveHeader = function doProgressiveHeader(canvas) {
  ...
  var aspectbox = document.querySelector('.aspectRatioPlaceholder');
  aspectbox = aspectbox ? aspectbox.querySelector('.aspect-ratio-fill') : false;
  var aspectMultiplier = aspectbox ? aspectbox.clientWidth / aspectbox.clientHeight : false;
  ...
  var expectedWidth = aspectMultiplier ? canvas.height * aspectMultiplier : false;
  var gridwidth = 1512; //width of the design grid - change this per project
  var startingresolution = Math.round(gridwidth / 4);
  ...
  background.onload = function () {
    ...
    var sizeMultiplier = expectedWidth ? background.naturalWidth / expectedWidth : false;
    var drawheight = sizeMultiplier ? canvas.height * sizeMultiplier : Math.min(canvas.height, background.naturalHeight);
    if (sizeMultiplier) {
...
var updateImage = function updateImage(canvas, ctx) {
  var currentresolution = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var counter = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var blurlevel = arguments.length > 4 ? arguments[4] : undefined;
  var aspectMultiplier = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  var leftcrop_pct = arguments.length > 6 ? arguments[6] : undefined;
  var expectedWidth = arguments.length > 7 ? arguments[7] : undefined;
  return new Promise(function (resolve, reject) {
    ...
    if (currentresolution < vw) {
      var nextresolution = parseInt(canvas.getAttribute('data-img-size-' + counter));
      var nextimage = canvas.getAttribute('data-img-src-' + counter);
      var checklast = 'data-img-size-' + (counter + 1);
      if (nextresolution && nextimage) {
        var moreimg = canvas.hasAttribute(checklast);
...
var accordionClick = function accordionClick(event) {
  ...
  var title = event.target.tagName === "H4" ? event.target : event.target.closest("H3");
...
var postit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(location, senddata) {
    var settings, fetchResponse, receivedata;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          return fetchResponse.json();
        case 7:
          receivedata = _context2.sent;
          return _context2.abrupt("return", receivedata);
        case 11:
          _context2.prev = 11;
  ...
  return function postit(_x3, _x4) {
...
var setupModals = function setupModals() {
  ...
  if (links) {
    var _iterator7 = _createForOfIteratorHelper(links),
      _step7;
    try {
