...
class Methods {
    /* 
     * The Methods Class is first and foremost where Block Render functions live
     * according to file structure convention
     * 
     * Legacy good code - here is where API & core permissions checking, IP checking,
     * and Request checking lives also. See below
     * 
